...
\begin{figure}
    ...
    \label{fig:plu_wheel}
    \subfloat{{\includegraphics[scale= 0.79]{images/emoji_categories_fix.pdf}}}%
    \caption{
        (\emph{Left}) 
...
\begin{figure}%
    \centering
    \subfloat{{\includegraphics[scale=0.24]{images/dis_country.eps}}}%
    \label{adsad}
    \subfloat{{\includegraphics[scale =0.24]{images/dis_lang.eps} }}%
    \caption{ 
